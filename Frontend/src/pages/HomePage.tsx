...
export default function HomePage() {
  ...
  const stats = [
    { label: "Growth Score", value: "842", trend: "+12%", icon: TrendingUp },
    { label: "Analyzed Repos", value: "14", trend: "+3 this week", icon: Github },
    { label: "Docs Processed", value: "5", trend: "Latest: Resume_v2", icon: FileText },
    { label: "Upcoming Deadlines", value: "2", trend: "Next: 3 days", icon: Calendar },
  ];

  const recentProjects = [
    { name: "uplink-core", tech: "React, Node", status: "Completed", time: "2 hours ago" },
    { name: "dravix-habit-tracker", tech: "Vue, Firebase", status: "In Progress", time: "Yesterday" },
    { name: "portfolio-v3", tech: "Next.js", status: "Needs Review", time: "3 days ago" }
  ];
  ...
  return (
    <div className="pb-10">
      <header className="mb-8">
        <h1 className="text-4xl font-bold mb-3 text-neutral-900 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-neutral-600 to-neutral-500 dark:from-neutral-400 dark:to-neutral-400">Welcome back, Student</h1>
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4 relative z-10">
                <div className="flex items-center gap-3">
                  ...
                  <h4 className="font-semibold text-neutral-900 dark:text-white group-hover:text-black dark:group-hover:text-white transition-colors">{project.name}</h4>
                </div>
              </div>
